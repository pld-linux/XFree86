...
Summary(pl):	Pliki nagЁСwkowe rozszerzenia PEX
Group:		X11/XFree86
...
Pliki nagЁСwkowe rozszerzenia PEX.
...
4.2.0 nie jest ju© doЁ╠czane domy╤lnie

%package XIE-devel
Summary:	XIE extension headers
Summary(pl):	Pliki nagЁСwkowe rozszerzenia XIE
Group:		X11/XFree86
...
Pliki nagЁСwkowe rozszerzenia XIE.
...
Summary(pl):	ModuЁ rozszerzenia PEX
Group:		X11/XFree86
...
ModuЁ rozszerzenia PEX dla X serwera. Od wersji XFree86 4.2.0 nie jest
ju© doЁ╠czane domy╤lnie.

%package module-XIE
Summary:	XIE extension module
Summary(pl):	ModuЁ rozszerzenia XIE
Group:		X11/XFree86
Requires:	%{name}-modules = %{version}
...
ModuЁ rozszerzenia XIE (X Image Extension) dla X serwera. Od wersji
XFree86 4.2.0 nie jest ju© doЁ╠czane domy╤lnie.
